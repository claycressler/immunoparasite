...
for (iij in c(20,10,5,1,0.5)) {
  results = data.frame(initT=rep(NA,6*10*201*191),
                       initTh1=rep(NA,6*10*201*191),
                       initP=rep(NA,6*10*201*191),
                       t=rep(NA,6*10*201*191),
                       Th1=rep(NA,6*10*201*191),
                       Th2=rep(NA,6*10*201*191),
                       P=rep(NA,6*10*201*191),
                       Th1bias=rep(NA,6*10*201*191),
                       Th2bias=rep(NA,6*10*201*191),
                       outcome=rep(NA,6*10*201*191))
  i = 1
