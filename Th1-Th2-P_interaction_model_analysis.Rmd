...
library(deSolve)
params = c(S1=1000, S2=1000, s1=2000, s2=2000, b1=0.1, b2=0.1, I12=10000, I21=10000, m=0.95, c1=1, c2=1.5, bp=4, Kp=80, a=0.004)
params2 <- c(params, T1=00)
flows <- flowField(T2P_cline_model, 
                   xlim=c(0,2000),
                   ylim=c(-50,200),
                   parameters=params2,
...
params = c(S1=1000, S2=1000, s1=2000, s2=2000, b1=0.1, b2=0.1, I12=10000, I21=10000, m=0.95, c1=1, c2=1.2, bp=4, Kp=150, a=0.004)
out <- gillespie_sim(100, y0=c(450, 450, 50), params=params, seed=12345)
