...
```{r Evol-dynamics-nested-model-variable-dose-variable-Th2-variable-outcome-2, fig.height=5, fig.width=8, units='in', res=300, fig.cap="Evolutionary dynamics of per-parasite virulence when hosts are immunologically variable at infection and thus infection outcome is variable."}
par(mfrow=c(1,1), mar=c(3.5,3.5,0.5,0.5), oma=rep(0,4))
plot.new()
plot.window(xlim=c(0,400), ylim=c(0,2e-4))
axis(1); axis(2); box('plot')
